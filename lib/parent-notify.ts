...
export async function notifyParentBigMoment(
  ...
  <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%">
    ...
    <tr><td style="padding:8px 0 24px">
      <a href="${appUrl()}/dashboard/parent" style="display:inline-block;background:#FB5A24;color:#fff;padding:14px 28px;border-radius:10px;font-weight:600;text-decoration:none;font-size:15px">See ${name}'s progress →</a>
    </td></tr>
