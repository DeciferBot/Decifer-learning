      ...
      <div className="grid grid-cols-2 gap-3">
        {OPTIONS.map((opt) => (
          <motion.button
            ...
            className="flex min-h-[96px] flex-col items-start gap-1 rounded-2xl border-2 border-black/8 bg-surface p-4 text-left transition-colors hover:border-opacity-60"
