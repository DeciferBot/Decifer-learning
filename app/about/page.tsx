// /about — everything the homepage used to say before it let anyone do anything.
//
// The parent case, the learning-intelligence cards, the six-stage pipeline, the
// gamification grid, the sample topics, the guides: all of it moved here from
// the homepage in one piece so nothing was lost, only relocated. The homepage
// now asks one question (learn, play or compete?) and answers it in one tap;
// this page is where a parent who wants the reasoning comes to read it.
...
export const metadata: Metadata = {
  title: 'About Decifer Learning',
  description:
    'Why Decifer exists, what a parent sees, how the Learn, Practise, Quiz loop works, and how every question is checked before a child sees it. UK National Curriculum, Years 1 to 11.',
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="mx-auto max-w-3xl px-4 pt-12 text-center md:pt-16">
          <p className="text-xs font-bold uppercase tracking-widest text-brand-700">About Decifer</p>
          <h1 className="mt-3 font-heading text-3xl font-black leading-tight text-ink sm:text-4xl">
            See your child build confidence, one topic at a time.
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-muted">
            Decifer gives parents a clear picture of their child&apos;s learning. What the curriculum covers. What they have done. Where they are strong. What to do next. It works alongside school and is built for parents as much as children.
          </p>
        </section>
        ...
        <section className="bg-brand-50 py-16">
          <div className="mx-auto max-w-md px-4 text-center">
            ...
            <p className="mb-8 text-sm text-muted">
              No credit card. Set-up takes a minute, and your child can start their first topic today.
            </p>
