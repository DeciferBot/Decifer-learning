...
export default async function CheckpointPage({ params }: { params: { id: string } }) {
  ...
  const { data: pool } = await supabase
    .from('quiz_questions')
    .select('id, tier, question_type, question_text, correct_answer, distractors, hint_1, hint_2, hint_3, explanation, technique_type, technique_hint, technique_note, answer_parts, source_text, source_label, source_type')
