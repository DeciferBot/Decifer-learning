...
const AIDS: Aid[] = [
  ...
  },
  {
    ...
    tagline: 'Swipe through time from dinosaurs to today',
    emoji: '⏳',
  ...
  },
  {
    ...
    tagline: 'Tap elements, watch reactions, discover chemistry',
    emoji: '⚗️',
  ...
  },
  {
    ...
    tagline: 'Browse habitats, meet species, hear calls',
    emoji: '🦁',
