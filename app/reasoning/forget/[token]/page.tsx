...
import { deleteLead } from '@/lib/reasoning/server'
...
export const metadata: Metadata = {
  title: 'Delete your reasoning report',
...
export default function ReasoningForgetPage({ params }: { params: { token: string } }) {
  return (
    <div className="space-y-6">
      <header className="space-y-3">
        ...
        <p className="text-[15px] leading-relaxed text-ink-2">
          ...
          this test. We never held anything that identifies your child, so there is nothing else
          to remove.
        </p>
      </header>
